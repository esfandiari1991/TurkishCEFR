...
// `FlowLayout` is declared once in `Views/Components/VocabCard.swift`
// and reused across the app. An earlier duplicate used to live here and
// produced "invalid redeclaration of 'FlowLayout'" at build time.
// Intentionally left as a comment so future greps turn up the history.
